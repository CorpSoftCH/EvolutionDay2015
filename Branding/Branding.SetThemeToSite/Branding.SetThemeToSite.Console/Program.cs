    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                new ThemeManager().DeployContosoThemeToWeb(cc, cc.Web, "CorporateSoftware",
                                    ( "C:/Git/PNP/Samples/Branding.SetThemeToSite/Branding.SetThemeToSite.Console/DeploymentFiles/CorporateSoftware/democolor.spcolor"),
                                    string.Empty,
                                    ("C:/Git/PNP/Samples/Branding.SetThemeToSite/Branding.SetThemeToSite.Console/DeploymentFiles/CorporateSoftware/CosoBackground.jpeg"),
                                    "seattle.master");

                // Setting the theme to web - can be sub site or root site
                new ThemeManager().SetThemeBasedOnName(cc, cc.Web, "CorporateSoftware");
