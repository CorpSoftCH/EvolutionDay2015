            ...
            using (var context = new ClientContext(uri))
{
    ...
    while (tenantSiteProperties == null || startIndex > 0)
    {
        ...
        private static void UploadAssetsToHostWeb(Web web)
        {
            ...
            string cssFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "C:/Git/PNP/Samples/Branding.InjectResponsiveCSS/Branding.InjectResponsiveCSS/Resources/Coso-Css.css");
